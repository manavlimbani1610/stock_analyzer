      ...
      >
        ...
        <Box sx={{
          ...
          <Box sx={{ display: 'flex', alignItems: 'center' }}>
            <Timeline sx={{ fontSize: { xs: 32, sm: 40 }, color: '#00d4ff', mr: 2 }} />
        ...
        <AnimatePresence>
          {!loading && predictions.length > 0 && (
            ...
            >
              ...
              {/* Chart */}
              <Paper sx={{ p: { xs: 1.5, sm: 2, md: 3 }, mb: 3, border: '1px solid rgba(0,212,255,0.2)' }}>
                ...
                <Box sx={{ width: '100%', overflowX: 'auto' }}>
                  <Box sx={{ minWidth: { xs: 300, sm: 'auto' } }}>
                    <ResponsiveContainer width="100%" height={window.innerWidth < 600 ? 280 : 400}>
                      <LineChart data={chartData} margin={{ top: 20, right: 20, left: 10, bottom: 5 }}>
                        ...
                        <YAxis
                          ...
                          tick={{ fontSize: window.innerWidth < 600 ? 10 : 12 }}
                          width={window.innerWidth < 600 ? 45 : 60}
                        />
                        <ChartTooltip
                          contentStyle={{
              ...
              {/* Forecast Table */}
              <Paper sx={{ p: { xs: 1.5, sm: 2, md: 3 }, border: '1px solid rgba(0,212,255,0.2)' }}>
                <Typography variant="h6" gutterBottom sx={{ display: 'flex', alignItems: 'center', fontSize: { xs: '1rem', sm: '1.25rem' } }}>
                ...
                <TableContainer sx={{ maxHeight: { xs: 300, sm: 400 } }}>
                  <Table stickyHeader size="small">
                    <TableHead>
                      <TableRow>
                        <TableCell sx={{ fontWeight: 'bold', bgcolor: 'rgba(0,212,255,0.1)', minWidth: 50 }}>Day</TableCell>
                        <TableCell sx={{ fontWeight: 'bold', bgcolor: 'rgba(0,212,255,0.1)', minWidth: 100 }}>Date</TableCell>
                        <TableCell align="right" sx={{ fontWeight: 'bold', bgcolor: 'rgba(0,212,255,0.1)', minWidth: 100 }}>Predicted</TableCell>
                        <TableCell align="right" sx={{ fontWeight: 'bold', bgcolor: 'rgba(0,212,255,0.1)', minWidth: 80, display: { xs: 'none', sm: 'table-cell' } }}>Change</TableCell>
                        <TableCell align="center" sx={{ fontWeight: 'bold', bgcolor: 'rgba(0,212,255,0.1)', minWidth: 80, display: { xs: 'none', md: 'table-cell' } }}>Confidence</TableCell>
                      </TableRow>
                    </TableHead>
                    <TableBody>
                      {predictions.map((row) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <TableCell sx={{ fontSize: { xs: '0.75rem', sm: '0.875rem' } }}>{row.date}</TableCell>
