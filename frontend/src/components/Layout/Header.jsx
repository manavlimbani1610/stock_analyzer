...
const Header = ({ onMenuClick }) => {
  ...
  const getNotificationIcon = (type) => {
    switch(type) {
      case 'success':
        return <CheckCircleIcon sx={{ color: 'var(--color-success)' }} />;
      case 'warning':
        return <WarningIcon sx={{ color: 'var(--color-warning)' }} />;
      case 'error':
        return <WarningIcon sx={{ color: 'var(--color-error)' }} />;
      case 'price_alert':
        return <TrendingUp sx={{ color: 'var(--color-primary)' }} />;
      default:
        return <InfoIcon sx={{ color: 'var(--color-info)' }} />;
    }
  };
        ...
        <Toolbar>
          ...
          >
            ...
            <MenuItem onClick={() => handleNavigate('/')} sx={{ py: 1 }}>
              <DashboardIcon sx={{ mr: 2, fontSize: 20, color: 'var(--color-primary)' }} />
              <Typography variant="body2">Dashboard</Typography>
            </MenuItem>

            <MenuItem onClick={() => handleNavigate('/portfolio')} sx={{ py: 1 }}>
              <PortfolioIcon sx={{ mr: 2, fontSize: 20, color: 'var(--color-success)' }} />
              <Typography variant="body2">My Portfolio</Typography>
            </MenuItem>

            <MenuItem onClick={() => handleNavigate('/settings')} sx={{ py: 1 }}>
              <SettingsIcon sx={{ mr: 2, fontSize: 20, color: 'var(--color-warning)' }} />
            ...
            <MenuItem onClick={handleLogout} sx={{ py: 1 }}>
              <LogoutIcon sx={{ mr: 2, fontSize: 20, color: 'var(--color-error)' }} />
              <Typography variant="body2" sx={{ color: 'var(--color-error)' }}>Logout</Typography>
            </MenuItem>
          </Menu>
