    ...
    <Box>
      ...
      <Paper sx={{
        ...
        <Box sx={{
          ...
          <Box>
            ...
            <Box sx={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: { xs: 1, sm: 2 } }}>
              <Typography variant="body2" color="text.secondary" sx={{ fontSize: { xs: '0.75rem', sm: '0.875rem' } }}>
                Updated: {format(lastRefreshed, 'MMM dd, HH:mm')}
              </Typography>
              <Chip
                icon={<RefreshIcon sx={{
                ...
                label={refreshing ? 'Updating...' : 'Auto-refresh'}
                size="small"
          ...
          <Box sx={{ display: 'flex', gap: { xs: 1, sm: 2 }, width: { xs: '100%', sm: 'auto' } }}>
            ...
            >
              <AddIcon sx={{ display: { xs: 'block', sm: 'none' }, mr: { xs: 0.5, sm: 0 } }} />
              <Box component="span" sx={{ display: { xs: 'none', sm: 'inline' } }}>Add Stock</Box>
              ...
              <Table size="small">
                <TableHead>
                  <TableRow>
                    ...
                    <TableCell align="right" sx={{ minWidth: 60 }}>Shares</TableCell>
                    <TableCell align="right" sx={{ display: { xs: 'none', md: 'table-cell' }, minWidth: 100 }}>Purchase</TableCell>
                    <TableCell align="right" sx={{ minWidth: 90 }}>Current</TableCell>
                    <TableCell align="right" sx={{ display: { xs: 'none', sm: 'table-cell' }, minWidth: 100 }}>Value</TableCell>
                    <TableCell align="right" sx={{ minWidth: 90 }}>P/L</TableCell>
                    <TableCell align="right" sx={{ display: { xs: 'none', lg: 'table-cell' }, minWidth: 80 }}>Return</TableCell>
                  ...
                  {portfolio.map((stock) => {
                    ...
                    return (
                      ...
                      >
                        <TableCell>
                          <Box>
                            <Typography fontWeight="bold" sx={{ fontSize: { xs: '0.875rem', sm: '1rem' } }}>{stock.symbol}</Typography>
                            <Typography variant="caption" color="text.secondary" sx={{ display: { xs: 'none', sm: 'block' } }}>
                              {stock.sector}
                            </Typography>
                          </Box>
                        </TableCell>
                        <TableCell align="right" sx={{ fontSize: { xs: '0.75rem', sm: '0.875rem' } }}>{stock.shares}</TableCell>
                        <TableCell align="right" sx={{ display: { xs: 'none', md: 'table-cell' } }}>{formatCurrency(stock.purchasePrice)}</TableCell>
                        <TableCell align="right">
                          <Typography fontWeight="medium" sx={{ fontSize: { xs: '0.75rem', sm: '0.875rem' } }}>
                            {formatCurrency(stock.currentPrice || stock.purchasePrice)}
                          </Typography>
                        </TableCell>
                        <TableCell align="right" sx={{ display: { xs: 'none', sm: 'table-cell' } }}>{formatCurrency(value)}</TableCell>
                        <TableCell align="right">
                          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end' }}>
                            {isProfit ? (
                              <TrendingUp sx={{ color: '#4caf50', mr: 0.5, fontSize: { xs: 14, sm: 16 } }} />
                            ) : (
                              <TrendingDown sx={{ color: '#f44336', mr: 0.5, fontSize: { xs: 14, sm: 16 } }} />
                            )}
                            <Typography
      ...
      {tabValue === 1 && (
        <Paper sx={{ p: { xs: 1.5, sm: 2, md: 3 } }}>
          ...
          <Box sx={{ height: { xs: 280, sm: 350, md: 400 }, mt: 2 }}>
